        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              @if(isAdmin() || Auth::user()->can('sale.add'))
              ...
              <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th>{{ __("Amount") }}</th>
                    <th>{{ __("Commission") }}</th>
                    <th>{{ __("Actual Paid Commission") }}</th>
                    <th>{{ __("Status") }}</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>@php $data = json_decode($sale->data) @endphp {!! isset($data->actual_price_commission) ? $data->actual_price_commission : '' !!}</td>
                    <td>
